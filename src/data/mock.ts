...
import type { Vehicle, Hold, BranchConfig, BranchId } from '../types';

// ── Branch Configs ────────────────────────────────────────────────────────────
export const BRANCH_CONFIGS: Record<BranchId, BranchConfig> = {
  'YWG':       { id: 'YWG',       name: 'Airport (YWG)',          enabledModules: ['my-day', 'holds', 'movement-log', 'my-shift', 'lost-and-found', 'audits', 'analytics', 'schedule', 'issue-log', 'manifest', 'fleet-master'] },
  'YWG-South': { id: 'YWG-South', name: 'Neighborhood (South)',    enabledModules: ['holds', 'movement-log', 'manifest'] },
  'YYC':       { id: 'YYC',       name: 'Calgary (YYC)',           enabledModules: ['holds', 'movement-log', 'my-shift', 'lost-and-found', 'audits', 'analytics', 'schedule', 'issue-log', 'manifest', 'fleet-master'] },
  'YVR':       { id: 'YVR',       name: 'Vancouver (YVR)',         enabledModules: ['holds', 'movement-log', 'my-shift', 'lost-and-found', 'audits', 'analytics', 'schedule', 'issue-log', 'manifest', 'fleet-master'] },
  'ALL':       { id: 'ALL',       name: 'All Branches',            enabledModules: ['holds', 'movement-log', 'my-shift', 'lost-and-found', 'audits', 'analytics', 'schedule', 'issue-log', 'manifest', 'fleet-master'] }
};
...
export const VEHICLES: Vehicle[] = [
  {
    id: 'v1', unitNumber: 'HRZ-4821', licensePlate: 'GHK 294',
  ...
  {
    id: 'v2', unitNumber: 'HRZ-3307', licensePlate: 'JFT 881',
    make: 'Chevrolet', model: 'Malibu', year: 2023, color: 'White',
    status: 'OUT_ON_EXCEPTION', branchId: 'YWG',
    isTesla: false, hasMobileCable: null, hasJ1772Adapter: null,
  },
  {
    id: 'v3', unitNumber: 'HRZ-5590', licensePlate: 'KLP 447',
    make: 'Ford', model: 'Escape', year: 2021, color: 'Black',
    status: 'RETURNED', branchId: 'YWG',
    isTesla: false, hasMobileCable: null, hasJ1772Adapter: null,
  },
  {
    id: 'v7', unitNumber: '5513130', licensePlate: 'LJF684',
    make: 'Tesla', model: 'Model Y', year: 2022, color: 'Black',
    status: 'HELD', branchId: 'YWG',
    isTesla: true, hasMobileCable: null, hasJ1772Adapter: null,
  },
  {
    id: 'v5', unitNumber: 'HRZ-2298', licensePlate: 'PBX 773',
    make: 'Hyundai', model: 'Elantra', year: 2022, color: 'Red',
    status: 'HELD', branchId: 'YWG-South',
    isTesla: false, hasMobileCable: null, hasJ1772Adapter: null,
  },
  // ── One-way arrivals from out-of-province (cross-branch demo) ──────────
  {
    id: 'v8', unitNumber: 'HRZ-7142', licensePlate: 'ABK 502',
    make: 'Nissan', model: 'Rogue', year: 2023, color: 'White',
    status: 'HELD', branchId: 'YWG',
    isTesla: false, hasMobileCable: null, hasJ1772Adapter: null,
  },
  {
    id: 'v9', unitNumber: 'HRZ-8819', licensePlate: 'BCP 224',
    make: 'Kia', model: 'Sportage', year: 2023, color: 'Grey',
    status: 'HELD', branchId: 'YWG',
    isTesla: false, hasMobileCable: null, hasJ1772Adapter: null,
  },
];
