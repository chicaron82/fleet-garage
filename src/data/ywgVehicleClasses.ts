...
export const YWG_VEHICLE_CLASSES: YWGVehicleEntry[] = [
  ...
  { unit: '5422118', plate: 'LUR266',  make: 'Toyota',     model: 'Camry',       year: 2025, color: 'White',  rentalClass: 'E6', owningBranch: 'WINNIPEG 08199'   },
  ...
  { unit: '5422100', plate: 'LUR265',  make: 'Toyota',     model: 'Corolla',     year: 2025, color: 'Gray',   rentalClass: 'E6', owningBranch: 'WINNIPEG 08199'   },
  ...
  { unit: '5753827', plate: '0ES679',  make: 'Toyota',     model: 'Corolla',     year: 2025, color: 'White',  rentalClass: 'E6', owningBranch: 'CALGARY 08193'    },
  ...
  { unit: '5420922', plate: 'LFJ306',  make: 'Kia',        model: 'Seltos',             year: 2025, color: 'Blue',   rentalClass: 'B5', owningBranch: 'WINNIPEG 08199'   },
  ...
  { unit: '5759733', plate: '0FB042',  make: 'Toyota',     model: 'Corolla',     year: 2025, color: 'Gray',   rentalClass: 'E6', owningBranch: 'CALGARY 08193'    },
  // Batch 2 — lot walk May 10, 2026
  { unit: '5429618', plate: 'LUR488',  make: 'Chevrolet',  model: 'Trailblazer',        year: 2026, color: 'Black',  rentalClass: 'B4', owningBranch: 'WINNIPEG 08199'   },
  { unit: '5424205', plate: 'LUR171',  make: 'Kia',        model: 'Seltos',             year: 2025, color: 'Orange', rentalClass: 'B5', owningBranch: 'WINNIPEG 08199'   },
  { unit: '5424296', plate: 'LUR180',  make: 'Nissan',     model: 'Kicks',              year: 2025, color: 'White',  rentalClass: 'B4', owningBranch: 'WINNIPEG 08199'   },
  { unit: '5424023', plate: 'LUR154',  make: 'Kia',        model: 'Seltos',             year: 2025, color: 'Orange', rentalClass: 'B5', owningBranch: 'WINNIPEG 08199'   },
  { unit: '5420211', plate: 'LFJ328',  make: 'Nissan',     model: 'Kicks',              year: 2025, color: 'Black',  rentalClass: 'B4', owningBranch: 'WINNIPEG 08199'   },
  { unit: '5424726', plate: 'LUR225',  make: 'Volkswagen', model: 'Jetta',              year: 2025, color: 'Gray',   rentalClass: 'C',  owningBranch: 'WINNIPEG 08199'   },
  { unit: '5429063', plate: 'LUR447',  make: 'Chevrolet',  model: 'Trax',               year: 2026, color: 'Black',  rentalClass: 'B4', owningBranch: 'WINNIPEG 08199'   },
  { unit: '5760871', plate: '0FD601',  make: 'Toyota',     model: 'Corolla',            year: 2025, color: 'Gray',   rentalClass: 'C',  owningBranch: 'CALGARY 08193'    },
  { unit: '5421649', plate: 'XT193P',  make: 'Nissan',     model: 'Rogue',              year: 2025, color: 'Gray',   rentalClass: 'Q4', owningBranch: 'WINNIPEG 08199'   },
  { unit: '5334446', plate: 'DFPL155', make: 'Volkswagen', model: 'Jetta',              year: 2025, color: 'Black',  rentalClass: 'C',  owningBranch: 'TORONTO 08197'    },
  { unit: '5420138', plate: 'LFJ311',  make: 'Kia',        model: 'Sportage',           year: 2025, color: 'Gray',   rentalClass: 'Q4', owningBranch: 'WINNIPEG 08199'   },
  { unit: '5429816', plate: 'LUR464',  make: 'Volkswagen', model: 'Jetta',              year: 2026, color: 'Silver', rentalClass: 'C',  owningBranch: 'WINNIPEG 08199'   },
  { unit: '5426895', plate: 'LUR382',  make: 'Nissan',     model: 'Sentra',             year: 2026, color: 'Black',  rentalClass: 'C',  owningBranch: 'WINNIPEG 08199'   },
  { unit: '5421417', plate: 'LUR112',  make: 'Ford',       model: 'Bronco Sport',       year: 2025, color: 'White',  rentalClass: 'Q4', owningBranch: 'WINNIPEG 08199'   },
  { unit: '5426507', plate: 'LUR389',  make: 'Toyota',     model: 'Corolla',            year: 2026, color: 'Gray',   rentalClass: 'C',  owningBranch: 'WINNIPEG 08199'   },
  { unit: '5424486', plate: 'LUR200',  make: 'Hyundai',    model: 'Elantra',            year: 2025, color: 'White',  rentalClass: 'C',  owningBranch: 'WINNIPEG 08199'   },
  { unit: '5420617', plate: 'LFJ372',  make: 'Kia',        model: 'Seltos',             year: 2025, color: 'White',  rentalClass: 'B5', owningBranch: 'WINNIPEG 08199'   },
  { unit: '5514039', plate: 'SB085H',  make: 'Tesla',      model: 'Model 3 Long Range', year: 2022, color: 'Blue',   rentalClass: 'E8', owningBranch: 'VAN DTG 08890'    },
  { unit: '5767546', plate: '0GK628',  make: 'Toyota',     model: 'Corolla',            year: 2026, color: 'Gray',   rentalClass: 'C',  owningBranch: 'CALGARY 08193'    },
  { unit: '5429576', plate: 'LUR497',  make: 'Nissan',     model: 'Rogue',              year: 2026, color: 'Black',  rentalClass: 'Q4', owningBranch: 'WINNIPEG 08199'   },
  { unit: '5429147', plate: 'LUR457',  make: 'Chevrolet',  model: 'Trax',               year: 2026, color: 'Black',  rentalClass: 'B4', owningBranch: 'WINNIPEG 08199'   },
  { unit: '5752852', plate: '0ES727',  make: 'Nissan',     model: 'Versa',              year: 2025, color: 'Black',  rentalClass: 'B',  owningBranch: 'CALGARY 08193'    },
  { unit: '5426473', plate: 'LUR386',  make: 'Toyota',     model: 'Corolla',            year: 2026, color: 'Gray',   rentalClass: 'C',  owningBranch: 'WINNIPEG 08199'   },
  { unit: '5420989', plate: 'LFJ301',  make: 'Nissan',     model: 'Altima',             year: 2025, color: 'White',  rentalClass: 'F',  owningBranch: 'WINNIPEG 08199'   },
  { unit: '5426408', plate: 'LFJ279',  make: 'Kia',        model: 'Forte',              year: 2024, color: 'White',  rentalClass: 'C',  owningBranch: 'WINNIPEG 08199'   },
  // BC plates — owning Vancouver 08191, in YWG circulation, registration expires November
  { unit: '3158854', plate: 'WC617T',  make: 'Kia',        model: 'Sportage',           year: 2025, color: 'Black',  rentalClass: 'Q4', owningBranch: 'VANCOUVER 08191'  },
  { unit: '3154770', plate: 'WF047P',  make: 'Nissan',     model: 'Kicks',              year: 2024, color: 'Blue',   rentalClass: 'B',  owningBranch: 'VANCOUVER 08191'  },
  { unit: '3162039', plate: 'XF541E',  make: 'Nissan',     model: 'Kicks',              year: 2025, color: 'Blue',   rentalClass: 'B4', owningBranch: 'VANCOUVER 08191'  },
];
