// The bougie eighths fuel slider — colour-coded E→Full with tick marks. Extracted from the old
// check-in form, then deleted with that screen (91ee00e); resurrected here (shared) for the
// Airport Flip return capture, where it beats typing "7/8" on a phone one-handed.
