...
import type { AuditSection, AuditCrewMember, AuditPosition } from '../../types';

// Presentational rows for AuditForm: a crew-assignment row (with employee-ID
// resolution) and a collapsible checklist section. Logic lives in useAudit.
