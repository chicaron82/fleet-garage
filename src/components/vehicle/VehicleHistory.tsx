        ...
        <div className="bg-white dark:bg-gray-900 transition-colors rounded-xl border border-gray-200 dark:border-gray-800 p-5">
          <div className="flex items-start justify-between">
            <div>
              ...
              <div className="mt-2"><VehicleRecordFacts vehicleId={vehicle.id} plate={vehicle.licensePlate} keytagPhotoUrl={vehicle.keytagPhotoUrl} keyCount={vehicle.keyCount} isTesla={vehicle.isTesla} classCode={vehicle.classCode} rentalClass={vehicle.rentalClass} /><VehicleNote vehicleId={vehicle.id} note={vehicle.note} noteAt={vehicle.noteAt} /></div>
              {vehicle.editStatus === 'pending' && (
