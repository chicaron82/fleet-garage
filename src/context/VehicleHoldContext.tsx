...
export interface VehicleHoldContextValue {
  ...
  directEditVehicleIdentity: (vehicleId: string, unit: string | null, plate: string, identity?: { make: string; model: string; year: number; color: string; rentalClass: string | null }) => Promise<void>;
  shuttlePlate: string;
