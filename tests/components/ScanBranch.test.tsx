...
function result(over: Partial<KeytagScanResult>): KeytagScanResult {
  return { rawPlate: 'LZM999', plate: 'LZM999', wasCorrected: false, vehicle: null, noIdentityKey: false, matchedByUnit: false, matchedByClippedTag: false, unitCandidates: [], resolution: { kind: 'new' }, ...over };
}
