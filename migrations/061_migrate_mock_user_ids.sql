...
SELECT tbl, mock_id, name, affected_rows FROM (
  ...
  UNION ALL
  SELECT 'shift_checkpoints',           m.mock_id, m.name, COUNT(*)      FROM shift_checkpoints     s JOIN id_map m ON s.logged_by        = m.mock_id GROUP BY m.mock_id, m.name
  UNION ALL
...
BEGIN;
  ...
  UPDATE shift_checkpoints    SET logged_by         = m.real_id FROM (VALUES ('u1','9f560505-ea86-4dcf-81d6-a9d960c9eae8'),('u2','d5316662-3855-4d53-9dca-4c2ad1096569'),('u3','8fa5ae06-8df4-4117-9c99-e14f7954a7c1'),('u4','16100fcd-b6a8-4208-b052-6043cb6d7d54'),('u5','5e68c1e3-d933-42ca-848b-fba70bd370c6'),('u6','cad144fd-d2de-481d-b876-d9c8e58b226b'),('u7','d5c0fa78-fd94-41c9-bfae-8762f699e3c8'),('u8','e0df695e-9e39-4bec-aeca-79565792539d'),('u9','f5c12ccb-f5fc-4a0d-a5c0-e87fcf8479e5'),('u10','d02817ce-a870-4234-a2d3-2d034ba6480e'),('u11','70b481c2-9492-4e2f-84ee-7cfc5bd7e7ef'),('u12','3b2a8659-4546-4231-9085-6d92e28a1133'),('u13','e39ea2d1-76d8-4348-bf71-598700128782'),('u14','204b9e39-345c-41bc-b408-40a2504da618'),('u15','5d227b68-8af2-4259-ba15-82a999656156'),('u16','e8550917-df55-4917-b77d-575213c8833f'),('u17','2440ff1f-7c36-4c30-9b7f-8b63be16f45e')) AS m(mock_id, real_id) WHERE logged_by = m.mock_id;
